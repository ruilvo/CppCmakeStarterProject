...
add_compile_definitions(CCSP_DEVELOPER_MODE)
...
foreach(DIAGNOSTIC_FLAG ${DIAGNOSTIC_FLAGS})
  check_cxx_compiler_flag(${DIAGNOSTIC_FLAG} CCSP_HAS_${DIAGNOSTIC_FLAG})
  if(CCSP_HAS_${DIAGNOSTIC_FLAG})
